...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0A2735);
  late Color secondary = const Color(0xFFEF6B25);
  late Color tertiary = const Color(0xFFFF8F39);
  late Color alternate = const Color(0xFFEFBE8E);
  late Color primaryText = const Color(0xFF333333);
  late Color secondaryText = const Color(0xFF666666);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F6FB);
