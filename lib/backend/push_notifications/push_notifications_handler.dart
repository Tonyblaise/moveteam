...
final parametersBuilderMap =
  ...
  'invoice_details': ParameterData.none(),
  ...
  'create_request': ParameterData.none(),
  'successful_request': ParameterData.none(),
  'homepage': ParameterData.none(),
  'Admin_dashboard': ParameterData.none(),
  'Invite_service_provider': ParameterData.none(),
  'admin_requests': ParameterData.none(),
  'more_details': (data) async => ParameterData(
        allParams: {
          'request': getParameter<DocumentReference>(data, 'request'),
        },
      ),
  'create_bid': (data) async => ParameterData(
        allParams: {
          'request': getParameter<DocumentReference>(data, 'request'),
        },
      ),
  'successful_bid': ParameterData.none(),
  'more_details_bid': (data) async => ParameterData(
        allParams: {
          'request': getParameter<DocumentReference>(data, 'request'),
        },
      ),
  'bids': (data) async => ParameterData(
        allParams: {
          'request': await getDocumentParameter<RequestsRecord>(
              data, 'request', RequestsRecord.fromSnapshot),
        },
      ),
  'successful_bid_assigned': ParameterData.none(),
  'rejected_bid': ParameterData.none(),
};
